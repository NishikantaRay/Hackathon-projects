		...
		<div align = "center">
			<div style = "width:300px; border: solid 1px #333333; " align = "left">
			   ...
			   <div style = "margin:30px">
				  ...
				  <form action = "include/request.php" method = "POST">
					 <label style="color: white;" for="qty">Food Quantity Needed :</label>
			   ...
			   <marquee style="bottom: 0; color: white;">TOLLFREE-1800-12345-123</marquee>
